...
CREATE TABLE PurchaseRequestDetails (
    ...
    UoM NVARCHAR(10) NOT NULL,
    SODetailID INT NULL UNIQUE,
    PODetailID INT NULL

    CONSTRAINT CHK_RequestedQty CHECK (RequestedQty > 0),
    CONSTRAINT FK_PRDetail_PODetail FOREIGN KEY (PODetailID) REFERENCES PurchaseOrderDetails(PODetailID),
    CONSTRAINT FK_PRDetail_SODetail FOREIGN KEY (SODetailID) REFERENCES SalesOrderDetails(SODetailID),
